package manjarrez.alan.thecheezery
...
class ProductosActivity : AppCompatActivity() {
    ...
    var productosMostrados = ArrayList<Product>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val categoria = intent.getStringExtra("categoria") ?: "coldDrinks"

        val tituloCategoriaImg = findViewById<ImageView>(R.id.tituloProductos)

        productosMostrados = when (categoria) {
        ...
        val imagenResId = when (categoria) {
            "coldDrinks" -> R.drawable.colddrinks
        ...
        tituloCategoriaImg.setImageResource(imagenResId)

        var listView: ListView = findViewById(R.id.litview) as ListView

        var adaptador: AdaptadorProductos = AdaptadorProductos(this, productosMostrados)
    ...
    private class AdaptadorProductos : BaseAdapter {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            precio.setText("$${prod.price.toInt()}")
